...
################################################################
# This is a generated script based on design: test_opfb_fironly
#
...
# source test_opfb_fironly_script.tcl
...
set design_name test_opfb_fironly
...
MazinLab:mkidgen3:fir_to_fft:1.6\
...
proc create_hier_cell_opfb { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 9 -to 0 m_axis_data_tuser
  ...
  set_property -dict [ list \
   ...
   CONFIG.CoefficientVector {1,0,0,0,0,0,0,0} \
  ...
  set fir_to_fft_0 [ create_bd_cell -type ip -vlnv MazinLab:mkidgen3:fir_to_fft:1.6 fir_to_fft_0 ]
  ...
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_0 [get_bd_intf_pins adc_to_opfb_0/lane_0] [get_bd_intf_pins fir_compiler_0/S_AXIS_DATA]
  connect_bd_intf_net -intf_net [get_bd_intf_nets adc_to_opfb_0_lane_0] [get_bd_intf_pins lane_0] [get_bd_intf_pins fir_compiler_0/S_AXIS_DATA]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets adc_to_opfb_0_lane_0]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_1 [get_bd_intf_pins adc_to_opfb_0/lane_1] [get_bd_intf_pins fir_compiler_1/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_2 [get_bd_intf_pins adc_to_opfb_0/lane_2] [get_bd_intf_pins fir_compiler_2/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_3 [get_bd_intf_pins adc_to_opfb_0/lane_3] [get_bd_intf_pins fir_compiler_3/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_4 [get_bd_intf_pins adc_to_opfb_0/lane_4] [get_bd_intf_pins fir_compiler_4/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_5 [get_bd_intf_pins adc_to_opfb_0/lane_5] [get_bd_intf_pins fir_compiler_5/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_6 [get_bd_intf_pins adc_to_opfb_0/lane_6] [get_bd_intf_pins fir_compiler_6/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_7 [get_bd_intf_pins adc_to_opfb_0/lane_7] [get_bd_intf_pins fir_compiler_7/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_8 [get_bd_intf_pins adc_to_opfb_0/lane_8] [get_bd_intf_pins fir_compiler_8/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_9 [get_bd_intf_pins adc_to_opfb_0/lane_9] [get_bd_intf_pins fir_compiler_9/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_10 [get_bd_intf_pins adc_to_opfb_0/lane_10] [get_bd_intf_pins fir_compiler_10/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_11 [get_bd_intf_pins adc_to_opfb_0/lane_11] [get_bd_intf_pins fir_compiler_11/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_12 [get_bd_intf_pins adc_to_opfb_0/lane_12] [get_bd_intf_pins fir_compiler_12/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_13 [get_bd_intf_pins adc_to_opfb_0/lane_13] [get_bd_intf_pins fir_compiler_13/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_14 [get_bd_intf_pins adc_to_opfb_0/lane_14] [get_bd_intf_pins fir_compiler_14/S_AXIS_DATA]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_15 [get_bd_intf_pins adc_to_opfb_0/lane_15] [get_bd_intf_pins fir_compiler_15/S_AXIS_DATA]
  ...
  connect_bd_intf_net -intf_net fir_compiler_10_M_AXIS_DATA [get_bd_intf_pins fir_compiler_10/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_10]
  connect_bd_intf_net -intf_net fir_compiler_11_M_AXIS_DATA [get_bd_intf_pins fir_compiler_11/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_11]
  connect_bd_intf_net -intf_net fir_compiler_12_M_AXIS_DATA [get_bd_intf_pins fir_compiler_12/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_12]
  connect_bd_intf_net -intf_net fir_compiler_13_M_AXIS_DATA [get_bd_intf_pins fir_compiler_13/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_13]
  connect_bd_intf_net -intf_net fir_compiler_14_M_AXIS_DATA [get_bd_intf_pins fir_compiler_14/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_14]
  connect_bd_intf_net -intf_net fir_compiler_15_M_AXIS_DATA [get_bd_intf_pins fir_compiler_15/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_15]
  connect_bd_intf_net -intf_net fir_compiler_1_M_AXIS_DATA [get_bd_intf_pins fir_compiler_1/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_1]
  connect_bd_intf_net -intf_net fir_compiler_2_M_AXIS_DATA [get_bd_intf_pins fir_compiler_2/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_2]
  connect_bd_intf_net -intf_net fir_compiler_3_M_AXIS_DATA [get_bd_intf_pins fir_compiler_3/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_3]
  connect_bd_intf_net -intf_net fir_compiler_4_M_AXIS_DATA [get_bd_intf_pins fir_compiler_4/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_4]
  connect_bd_intf_net -intf_net fir_compiler_5_M_AXIS_DATA [get_bd_intf_pins fir_compiler_5/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_5]
  connect_bd_intf_net -intf_net fir_compiler_6_M_AXIS_DATA [get_bd_intf_pins fir_compiler_6/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_6]
  connect_bd_intf_net -intf_net fir_compiler_7_M_AXIS_DATA [get_bd_intf_pins fir_compiler_7/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_7]
  connect_bd_intf_net -intf_net fir_compiler_8_M_AXIS_DATA [get_bd_intf_pins fir_compiler_8/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_8]
  connect_bd_intf_net -intf_net fir_compiler_9_M_AXIS_DATA [get_bd_intf_pins fir_compiler_9/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_9]
  connect_bd_intf_net -intf_net fir_to_fft_0_output_r [get_bd_intf_pins output_r] [get_bd_intf_pins fir_to_fft_0/output_r]
  ...
  connect_bd_intf_net -intf_net pfb_firs_M_AXIS_DATA [get_bd_intf_pins fir_compiler_0/M_AXIS_DATA] [get_bd_intf_pins fir_to_fft_0/input_0]
  connect_bd_intf_net -intf_net [get_bd_intf_nets pfb_firs_M_AXIS_DATA] [get_bd_intf_pins M_AXIS_DATA] [get_bd_intf_pins fir_compiler_0/M_AXIS_DATA]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets pfb_firs_M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net dout [get_bd_pins dout1] [get_bd_pins xlconcat_1/dout]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets dout]
  ...
  connect_bd_net -net fir_compiler_0_m_axis_data_tuser [get_bd_pins m_axis_data_tuser] [get_bd_pins fir_compiler_0/m_axis_data_tuser]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets fir_compiler_0_m_axis_data_tuser]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins ap_rst_n] [get_bd_pins adc_to_opfb_0/ap_rst_n] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins fir_compiler_0/aresetn] [get_bd_pins fir_compiler_1/aresetn] [get_bd_pins fir_compiler_10/aresetn] [get_bd_pins fir_compiler_11/aresetn] [get_bd_pins fir_compiler_12/aresetn] [get_bd_pins fir_compiler_13/aresetn] [get_bd_pins fir_compiler_14/aresetn] [get_bd_pins fir_compiler_15/aresetn] [get_bd_pins fir_compiler_2/aresetn] [get_bd_pins fir_compiler_3/aresetn] [get_bd_pins fir_compiler_4/aresetn] [get_bd_pins fir_compiler_5/aresetn] [get_bd_pins fir_compiler_6/aresetn] [get_bd_pins fir_compiler_7/aresetn] [get_bd_pins fir_compiler_8/aresetn] [get_bd_pins fir_compiler_9/aresetn] [get_bd_pins fir_to_fft_0/ap_rst_n] [get_bd_pins opfb_fir_cfg_0/ap_rst_n]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ap_clk] [get_bd_pins adc_to_opfb_0/ap_clk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins fir_compiler_1/aclk] [get_bd_pins fir_compiler_10/aclk] [get_bd_pins fir_compiler_11/aclk] [get_bd_pins fir_compiler_12/aclk] [get_bd_pins fir_compiler_13/aclk] [get_bd_pins fir_compiler_14/aclk] [get_bd_pins fir_compiler_15/aclk] [get_bd_pins fir_compiler_2/aclk] [get_bd_pins fir_compiler_3/aclk] [get_bd_pins fir_compiler_4/aclk] [get_bd_pins fir_compiler_5/aclk] [get_bd_pins fir_compiler_6/aclk] [get_bd_pins fir_compiler_7/aclk] [get_bd_pins fir_compiler_8/aclk] [get_bd_pins fir_compiler_9/aclk] [get_bd_pins fir_to_fft_0/ap_clk] [get_bd_pins opfb_fir_cfg_0/ap_clk]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins opfb/lane_0] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins opfb/M_AXIS_DATA] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets opfb_output_r] [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets opfb_output_r]
  ...
  connect_bd_net -net opfb_dout1 [get_bd_pins opfb/dout1] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net opfb_m_axis_data_tuser [get_bd_pins opfb/m_axis_data_tuser] [get_bd_pins system_ila_0/probe1]
