...
################################################################
# This is a generated script based on design: test_adc2opfb
#
...
# source test_adc2opfb_script.tcl
...
MazinLab:mkidgen3:adc_to_opfb:0.3\
...
proc create_hier_cell_dut { parentCell nameHier } {
  ...
  set adc_to_opfb_0 [ create_bd_cell -type ip -vlnv MazinLab:mkidgen3:adc_to_opfb:0.3 adc_to_opfb_0 ]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXIS] [get_bd_intf_pins axis_data_fifo_2/S_AXIS]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M_AXIS] [get_bd_intf_pins axis_data_fifo_3/M_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_0 [get_bd_intf_pins adc_to_opfb_0/lane_0] [get_bd_intf_pins axis_combiner_0/S00_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_1 [get_bd_intf_pins adc_to_opfb_0/lane_1] [get_bd_intf_pins axis_combiner_0/S01_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_2 [get_bd_intf_pins adc_to_opfb_0/lane_2] [get_bd_intf_pins axis_combiner_0/S02_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_3 [get_bd_intf_pins adc_to_opfb_0/lane_3] [get_bd_intf_pins axis_combiner_0/S03_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_4 [get_bd_intf_pins adc_to_opfb_0/lane_4] [get_bd_intf_pins axis_combiner_0/S04_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_5 [get_bd_intf_pins adc_to_opfb_0/lane_5] [get_bd_intf_pins axis_combiner_0/S05_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_6 [get_bd_intf_pins adc_to_opfb_0/lane_6] [get_bd_intf_pins axis_combiner_0/S06_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_7 [get_bd_intf_pins adc_to_opfb_0/lane_7] [get_bd_intf_pins axis_combiner_0/S07_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_8 [get_bd_intf_pins adc_to_opfb_0/lane_8] [get_bd_intf_pins axis_combiner_0/S08_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_9 [get_bd_intf_pins adc_to_opfb_0/lane_9] [get_bd_intf_pins axis_combiner_0/S09_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_10 [get_bd_intf_pins adc_to_opfb_0/lane_10] [get_bd_intf_pins axis_combiner_0/S10_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_11 [get_bd_intf_pins adc_to_opfb_0/lane_11] [get_bd_intf_pins axis_combiner_0/S11_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_12 [get_bd_intf_pins adc_to_opfb_0/lane_12] [get_bd_intf_pins axis_combiner_0/S12_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_13 [get_bd_intf_pins adc_to_opfb_0/lane_13] [get_bd_intf_pins axis_combiner_0/S13_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_14 [get_bd_intf_pins adc_to_opfb_0/lane_14] [get_bd_intf_pins axis_combiner_0/S14_AXIS]
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane_15 [get_bd_intf_pins adc_to_opfb_0/lane_15] [get_bd_intf_pins axis_combiner_0/S15_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins adc_to_opfb_0/istream_data] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins adc_to_opfb_0/qstream_data] [get_bd_intf_pins axis_broadcaster_0/M01_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS [get_bd_intf_pins axis_combiner_0/M_AXIS] [get_bd_intf_pins axis_data_fifo_3/S_AXIS]
  ...
  connect_bd_net -net m_axis_aclk_1 [get_bd_pins m_axis_aclk] [get_bd_pins axis_data_fifo_2/s_axis_aclk] [get_bd_pins axis_data_fifo_3/m_axis_aclk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins adc_to_opfb_0/ap_rst_n] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_data_fifo_3/s_axis_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net s_axis_aresetn_1 [get_bd_pins s_axis_aresetn] [get_bd_pins axis_data_fifo_2/s_axis_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins adc_to_opfb_0/ap_clk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_data_fifo_2/m_axis_aclk] [get_bd_pins axis_data_fifo_3/s_axis_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins dut/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_combiner_0_M_AXIS] [get_bd_intf_pins dut/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins dut/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_1_M_AXIS] [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins dut/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins dut/m_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins dut/ext_reset_in] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
