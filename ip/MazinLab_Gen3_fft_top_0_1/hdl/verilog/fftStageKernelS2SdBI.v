...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module fftStageKernelS2SdBI_rom (
...
initial begin
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram0);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram1);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram2);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram3);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram4);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram5);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram6);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram7);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram8);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram9);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram10);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram11);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram12);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram13);
    $readmemh("./fftStageKernelS2SdBI_rom.dat", ram14);
end
...
fftStageKernelS2SdBI_rom fftStageKernelS2SdBI_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
