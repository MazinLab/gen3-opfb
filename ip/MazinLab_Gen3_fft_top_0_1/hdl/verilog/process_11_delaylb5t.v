...
module process_11_delaylb5t_core (
    clk,
    ce,
    din,
    addr,
...
parameter AddressRange = 32'd112;
...
process_11_delaylb5t_core #(
    .DATA_WIDTH( DataWidth ),
    .ADDR_WIDTH( AddressWidth ),
    .DEPTH( AddressRange ))
process_11_delaylb5t_core_U(
    .clk(clk),
    .ce(we0),
    .din(d0),
    .addr(address0),
