...
entity gen3_opfb is
  ...
  attribute CORE_GENERATION_INFO of gen3_opfb : entity is "gen3_opfb,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=gen3_opfb,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=44,numReposBlks=43,numNonXlnxBlks=5,numHierBlks=1,maxHierDepth=1,numSysgenBlks=1,numHlsBlks=4,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=1,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of gen3_opfb is
  ...
  attribute X_INTERFACE_PARAMETER of clk_100MHz : signal is "XIL_INTERFACENAME CLK.CLK_100MHZ, ASSOCIATED_BUSIF M_AXIS_IQBINS:S_AXIS_I:S_AXIS_Q, CLK_DOMAIN gen3_opfb_clk_100MHz, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000";
  attribute X_INTERFACE_INFO of M_AXIS_IQBINS_tdata : signal is "xilinx.com:interface:axis:1.0 M_AXIS_IQBINS TDATA";
  attribute X_INTERFACE_PARAMETER of M_AXIS_IQBINS_tdata : signal is "XIL_INTERFACENAME M_AXIS_IQBINS, CLK_DOMAIN gen3_opfb_clk_100MHz, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 64, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 16";
  ...
  attribute X_INTERFACE_PARAMETER of S_AXIS_I_tdata : signal is "XIL_INTERFACENAME S_AXIS_I, CLK_DOMAIN gen3_opfb_clk_100MHz, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
  attribute X_INTERFACE_INFO of S_AXIS_Q_tdata : signal is "xilinx.com:interface:axis:1.0 S_AXIS_Q TDATA";
  attribute X_INTERFACE_PARAMETER of S_AXIS_Q_tdata : signal is "XIL_INTERFACENAME S_AXIS_Q, CLK_DOMAIN gen3_opfb_clk_100MHz, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
begin
